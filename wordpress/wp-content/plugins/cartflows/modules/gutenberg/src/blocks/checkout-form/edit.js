...
class CFCheckoutFormEdit extends Component {
	...
	render() {
		...
		if( inputLoadGoogleFonts == true ){
			const inputconfig = {
				google: {
					families: [ globalFontFamily + ( globalFontWeight ? ":" + globalFontWeight : "" ) ],
				},
			}
		...
		if( globalLoadGoogleFonts == true ) {
			...
			loadglobalGoogleFonts = (
				<WebfontLoader config={ globalconfig }>
				</WebfontLoader>
			)
		}
		...
		if( cf_blocks_info.is_cartflows_pro_install === '' ){
			Options = [
				...
				{ value: "one-column", label: __( "One Column ( Pro )" ) },
				{ value: "two-step", label: __( "Two Step ( Pro )" ) },
			];
		}else{
			Options = [
				{ value: "two-column", label: __( "Two Column" ) },
				{ value: "one-column", label: __( "One Column" ) },
				{ value: "two-step", label: __( "Two Step" ) },
			];	
		}
		...
		const layout_settings = () => {		
				...
				<PanelBody title={ __( "Layout" ) } initialOpen={ true }>
                        <Fragment>
                            ...
                            options={ Options } 
                        />
                        { ( "two-step" == layout && (cf_blocks_info.is_cartflows_pro_install === '') ) &&(
                            <p className="cf-settings-notice">{ __( "Note: This feature is available in the CartFlows Pro. Upgrade Now!." ) }</p>
                        )}
						{ ( "one-column" == layout && (cf_blocks_info.is_cartflows_pro_install === '') ) &&(
                            <p className="cf-settings-notice">{ __( "Note: This feature is available in the CartFlows Pro. Upgrade Now!." ) }</p>
                        )}
                        </Fragment>
				</PanelBody>
		...
		const global_settings = () => {		
			return (
				<PanelBody title={ __( "Global" ) } initialOpen={ false }>
					<p className="cf-setting-label">{ __( "Primary Color" ) }
					<span className="components-base-control__label">
						<span className="component-color-indicator" style={{ backgroundColor: globalbgColor }} ></span></span></p>
				<ColorPalette
					value={ globalbgColor }
					onChange={ ( colorValue ) => setAttributes( { globalbgColor: colorValue } ) }
					allowReset
				/>
				<p className="cf-setting-label">{ __( "Text Color" ) }
					<span className="components-base-control__label">
						<span className="component-color-indicator" style={{ backgroundColor: globaltextColor }} ></span></span></p>
				<ColorPalette
					value={ globaltextColor }
					onChange={ ( colorValue ) => setAttributes( { globaltextColor: colorValue } ) }
					allowReset
				/>
				<TypographyControl
					label={ __( "Typography" ) }
					...
					loadGoogleFonts = { { value: globalLoadGoogleFonts, label: 'globalLoadGoogleFonts' } }
					fontFamily = { { value: globalFontFamily, label: 'globalFontFamily' } }
					fontWeight = { { value: globalFontWeight, label: 'globalFontWeight' } }
					fontSubset = { { value: globalFontSubset, label: 'globalFontSubset' } }
					fontSizeType = { { value: globalFontSizeType, label: 'globalFontSizeType' } }
					fontSize = { { value: globalFontSize, label: 'globalFontSize' } }
					fontSizeMobile = { { value: globalFontSizeMobile, label: 'globalFontSizeMobile' } }
					fontSizeTablet= { { value: globalFontSizeTablet, label: 'globalFontSizeTablet' } }
					lineHeightType = { { value: globalLineHeightType, label: 'globalLineHeightType' } }
					lineHeight = { { value: globalLineHeight, label: 'globalLineHeight' } }
					lineHeightMobile = { { value: globalLineHeightMobile, label: 'globalLineHeightMobile' } }
					lineHeightTablet= { { value: globalLineHeightTablet, label: 'globalLineHeightTablet' } }
				/>
				</PanelBody>
			)
		}
		...
		if( cf_blocks_info.is_cartflows_pro_install === '' ){
			skinOption = [
				...
				{ value: "style-one", label: __( "Floating label ( Pro )" ) },
			]
		}else{
			skinOption = [
				{ value: "deafult", label: __( "Default" ) },
				{ value: "style-one", label: __( "Floating label" ) },
			]
		}
		
		const field_border_setting = () => { return (
			<PanelBody title={ __( "Input Field" ) } initialOpen = { false } > 
				 { ( "two-column" == layout ) &&
                        <Fragment>
                            ...
                            options={ skinOption } 
                        />
                        { ( "style-one" == inputSkins && (cf_blocks_info.is_cartflows_pro_install === '') ) &&(
                            <p className="cf-settings-notice">{ __( "Note: This feature is available in the CartFlows Pro. Upgrade Now!." ) }</p>
                        )}
                        </Fragment>
                        }
						<h2>{ __( "Label" ) }</h2>	
						<p className="cf-setting-label">{ __( "Color" ) }
							<span className="components-base-control__label">
						...
						<h2>{ __( "Input/Text Placeholder Color" ) }</h2>
						<p className="cf-setting-label">{ __( "Color" ) }
							<span className="components-base-control__label">
						...
						/>	
						<hr className="cf-editor__separator" />
						<p className="cf-setting-label">{ __( "Field Background Color" ) }
							<span className="components-base-control__label">
		...
		const headingSettings = () => {
			return (
				...
				<p className="cf-setting-label">{ __( "Color" ) }
					<span className="components-base-control__label">
						<span className="component-color-indicator" style={{ backgroundColor: headBgColor }} ></span>
					</span>
				</p>
				<ColorPalette
					value={ headBgColor }
					onChange={ ( colorValue ) => setAttributes( { headBgColor: colorValue } ) }
					allowReset
				/>
				<TypographyControl
					label={ __( "Typography" ) }
									...
									if( "normal" === tabName.name ) {
										tabout =  (
											<Fragment>
												<p className="cf-setting-label">{ __( "Text Color" ) }
													<span className="components-base-control__label">
														<span className="component-color-indicator" style={{ backgroundColor: buttonTextColor }} ></span>
													</span>
												</p>
												<ColorPalette
										...
										tabout = (
											<Fragment>
												<p className="cf-setting-label">{ __( "Text Hover Color" ) }
													<span className="components-base-control__label">
												...
												<ColorPalette
													...
													allowReset
												/>
												<p className="cf-setting-label">{ __( "Background Hover Color" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={{ backgroundColor: backgroundHoverColor }} ></span></span></p>
												<ColorPalette
			...
			<Fragment>				
				...
				/>
					...
					<ButtonGroup className="cf-size-type-field" aria-label={ __( "Size Type" ) }>
						<Button key={ "px" } className="cf-size-btn" isSmall isPrimary={ buttonBorderRadiusType === "px" } aria-pressed={ buttonBorderRadiusType === "px" } onClick={ () => setAttributes( { buttonBorderRadiusType: "px" } ) }>{ "px" }</Button>
						<Button key={ "%" } className="cf-size-btn" isSmall isPrimary={ buttonBorderRadiusType === "%" } aria-pressed={ buttonBorderRadiusType === "%" } onClick={ () => setAttributes( { buttonBorderRadiusType: "%" } ) }>{ "%" }</Button>
					</ButtonGroup>
					<RangeControl
		...
		const buttonNormalSettings = (
			<Fragment>
				{ "none" != buttonBorderStyle && (
					<Fragment>
						<p className="cf-setting-label">{ __( "Border Color" ) }
							<span className="components-base-control__label">
		...
		const buttonHoverSettings = (
			<Fragment>
				{ "none" != buttonBorderStyle && (
					<Fragment>
						<p className="cf-setting-label">{ __( "Border Hover Color" ) }
							<span className="components-base-control__label">
		...
		const payment_Settings = () => {
			return (
				<PanelBody title={ __( "Payment Section" ) } initialOpen={ false }>
					<p className="cf-setting-label">{ __( "Title Color" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={{ backgroundColor: paymenttitleColor }} ></span></span></p>
					<ColorPalette
						value={ paymenttitleColor }
						onChange={ ( value ) => setAttributes( { paymenttitleColor: value } ) }
						allowReset
					/>
					<hr className="cf-editor__separator" />
					<p className="cf-setting-label">{ __( "Description Color" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={{ backgroundColor: paymentdescriptionColor }} ></span></span></p>
						<ColorPalette
							value={ paymentdescriptionColor }
							onChange={ ( value ) => setAttributes( { paymentdescriptionColor: value } ) }
							allowReset
					/>
					<hr className="cf-editor__separator" />
					<p className="cf-setting-label">{ __( "Section Background Color" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={{ backgroundColor: sectionbgColor }} ></span></span></p>
					<ColorPalette
					...
					/>
					<hr className="cf-editor__separator" />
					<p className="cf-setting-label">{ __( "Information Background Color" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={{ backgroundColor: informationbgColor }} ></span></span></p>
						<ColorPalette
							value={ informationbgColor }
							onChange={ ( value ) => setAttributes( { informationbgColor: value } ) }
							allowReset
					/>
					<hr className="cf-editor__separator" />
					<h2>{ __( "Section Padding (px)" ) }</h2>
					<RangeControl
						label={ CF_Block_Icons.horizontal_spacing }
						className={ "cf-margin-control" }
						value={ sectionvrPadding }
						onChange={ ( value ) => setAttributes( { sectionvrPadding: value } ) }
						min={ 0 }
						max={ 100 }
						allowReset
					/>					
					<RangeControl
						...
						onChange={ ( value ) => setAttributes( { sectionhrPadding: value } ) }
						min={ 0 }
						max={ 100 }
						allowReset
					/>
					<h2>{ __( "Section Margin (px)" ) }</h2>
					<RangeControl
						label={ CF_Block_Icons.horizontal_spacing }
						className={ "cf-margin-control" }
						value={ sectionvrMargin }
						onChange={ ( value ) => setAttributes( { sectionvrMargin: value } ) }
						min={ 0 }
						max={ 100 }
						allowReset
					/>					
					<RangeControl
						...
						onChange={ ( value ) => setAttributes( { sectionhrMargin: value } ) }
						min={ 0 }
						max={ 100 }
						allowReset
					/>
					<h2>{ __( "Section Rounded Corners" ) }</h2>
					<RangeControl
		...
		const msg_settings = () => {		
			return (
				...
				<p className="cf-settings-notice">{ __( "Note: This styling can be only seen at frontend" ) }</p>		
				<h2>{ __( "Form success / Error validation" ) }</h2>
				<h2>{ __( "Field Validation" ) }</h2>
				<p className="cf-setting-label">{ __( "Label Color" ) }
					<span className="components-base-control__label">
						<span className="component-color-indicator" style={{ backgroundColor: errorLabelColor }} ></span></span></p>
				<ColorPalette
					value={ errorLabelColor }
					onChange={ ( colorValue ) => setAttributes( { errorLabelColor: colorValue } ) }
					allowReset
				/>
				<p className="cf-setting-label">{ __( "Border Color" ) }
					<span className="components-base-control__label">
						<span className="component-color-indicator" style={{ backgroundColor: errorFieldBorderColor }} ></span></span></p>
				<ColorPalette
					value={ errorFieldBorderColor }
					onChange={ ( colorValue ) => setAttributes( { errorFieldBorderColor: colorValue } ) }
					allowReset
				/>
				<hr className="cf-editor__separator" />
				<h2>{ __( "Error Message" ) }</h2>
				<p className="cf-setting-label">{ __( "Message Color" ) }
					<span className="components-base-control__label">
				...
				<ColorPalette
					...
					allowReset
				/>
				<p className="cf-setting-label">{ __( "Background Color" ) }
					<span className="components-base-control__label">
	...
	componentDidMount() {
		...
		$style.setAttribute( "id", "cf-checkout-form-style-" + this.props.clientId.substr( 0, 8 ) )
		document.head.appendChild( $style )
	}

	componentDidUpdate(prevProps, prevState) {
		var element = document.getElementById( "cf-checkout-form-style-" + this.props.clientId.substr( 0, 8 ) )
		...
		if ( prevProps.attributes.orderBumpSkin != this.props.attributes.orderBumpSkin ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.orderBumpCheckboxArrow != this.props.attributes.orderBumpCheckboxArrow ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.orderBumpCheckboxArrowAnimation != this.props.attributes.orderBumpCheckboxArrowAnimation ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.sectionposition != this.props.attributes.sectionposition ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.productOptionsSkin != this.props.attributes.productOptionsSkin ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.productOptionsImages != this.props.attributes.productOptionsImages ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if( prevProps.attributes.productOptionsSectionTitleText != this.props.attributes.productOptionsSectionTitleText ){
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.PreSkipText != this.props.attributes.PreSkipText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.PreOrderText != this.props.attributes.PreOrderText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.PreProductTitleText != this.props.attributes.PreProductTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.preSubTitleText != this.props.attributes.preSubTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.preTitleText != this.props.attributes.preTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.PreProductDescText != this.props.attributes.PreProductDescText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}
		...
		if ( prevProps.attributes.inputSkins != this.props.attributes.inputSkins ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.enableNote != this.props.attributes.enableNote ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}
		...
		if ( prevProps.attributes.stepOneTitleText != this.props.attributes.stepOneTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.stepOneSubTitleText != this.props.attributes.stepOneSubTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.stepTwoTitleText != this.props.attributes.stepTwoTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.stepTwoSubTitleText != this.props.attributes.stepTwoSubTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.offerButtonTitleText != this.props.attributes.offerButtonTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}

		if ( prevProps.attributes.offerButtonSubTitleText != this.props.attributes.offerButtonSubTitleText ) {
			const { setAttributes } = this.props
			setAttributes( { isHtml: false } )
		}
	...
	if ( formId && -1 != formId && 0 != formId && ! isHtml ) {
		...
		jQuery.ajax({
			...
			data: {
				...
				orderBumpCheckboxArrowAnimation : props.attributes.orderBumpCheckboxArrowAnimation,
				...
				productOptionsSectionTitleText: props.attributes.productOptionsSectionTitleText,
				...
				offerButtonSubTitleText : props.attributes.offerButtonSubTitleText
			},
			dataType: "json",
			type: "POST",
