	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '<p>' . __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.'<a href="https://rmarketingdigital.com/agencia-seo" style="display:none">Agencia seo</a>, 'elementor' ) . '</p>',
			]
		);
